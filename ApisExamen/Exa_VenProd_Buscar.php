...
if(isset($_REQUEST['Id_Prod']))
{
	...
	$Query = "select R.Nombre, R.Presentacion, R.Precio, P.Cantidad from registro_productos R, productos_inventario P where R.Id_Prod = '$Id_Prod' AND P.Id_Prod = '$Id_Prod'";
